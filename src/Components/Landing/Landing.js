  ...
  const SliderCards = Data.getHomeSliders().map((cardData, index) => {
    return (
      <SwiperSlide className={style.slider_item} key={index}>
        <Image src={cardData.image} width={2000} height={410} className="w-100 h-100x" />
      </SwiperSlide>
    );
  });
  return (
      ...
      <div className={`container-fluid  my-3 ${style.landing_body} `}>
        <div className="row" style={{ justifyContent: "center" }}>
          <div className="col-4 d-flex flex-column justify-content-between">
            <Image src="/assets/banner/samsungs23Ultra.jpg" width={800} height={200} />
            <Image src="/assets/banner/GalaxyZFold4.webp" width={800} height={200} />
          </div>
          <div className="col-8">
            <Swiper
              spaceBetween={10}
